<div class="sidebar">
    <div class="list-group">
        ...
        ?>
            ...
            <a href="loaikhachhang.php" class="list-group-item list-group-item-action <?php if(basename($_SERVER['SCRIPT_NAME']) ==  'loaikhachhang.php') echo " active"; ?>">Thêm Loại Khách Hàng Hàng</a>
            ...
            <a href="danh_sach_loai_khach_hang.php" class="list-group-item list-group-item-action <?php if(basename($_SERVER['SCRIPT_NAME']) ==  'danh_sach_loai_khach_hang.php') echo " active"; ?>">Phân Loại Khách Hàng</a>
